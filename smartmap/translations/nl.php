...
return array(
	...
	'Manage how the subfields will be arranged.' => 'Stel vast hoe sub-velden worden gearrangeerd.',
	'Label' => 'label',

	// Address field
	'Street Address' => 'Adres',
	'Apartment or Suite' => 'Adres regel 2 (optioneel)',
	'City' => 'Plaats',
	'State' => 'Provincie',
	'Zip Code' => 'Postcode',
	'Country' => 'Land',
	'Latitude' => 'Latitude',
	'Longitude' => 'Longitude',
	'Search Addresses' => 'Zoek adres',
	'Drag Pin' => 'Versleep Speld',

	// Search results modal
	'Showing 1 search result...' => '1 Zoekresultaat...',
	'Showing {total} search results...' => '{total} zoekresultaten...',

	// Error messages
	'No address provided. Please enter a partial address to search for.' => 'Er is geen adres opgegeven. Voer een deel van het adres in om het op te zoeken.',
	'The geocode was successful but returned no results.' => 'De geocode is juist maar heeft geen resultaat opgeleverd.',
	...
	'If your website is on a shared server, or' => 'Is je server een gedeelde server, of',
	'If you expect extremely high traffic to your website.' => 'Als je extreem veel verkeer naar je website verwacht.',
	...
	'<strong>Step 3:</strong> Copy your <a href="{url}" target="_blank">security access information</a> and paste it here...' => '<strong>Stap 3:</strong> Kopieer je <a href="{url}" target="_blank">inlog gegevens</a> en plak ze hier in...',
	'(service disabled)' => '(service inactief)',
