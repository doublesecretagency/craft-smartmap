...
return array(
	...
	// 'Manage how the subfields will be arranged.' => '',
	// 'Label' => '',

	// Address field
	// 'Street Address' => '',
	'Apartment or Suite' => 'House No. or Name',
	'City' => 'Town/City',
	'State' => 'County',
	'Zip Code' => 'Postcode',
	// 'Country' => '',
	...
	// Error messages
	// 'No address provided. Please enter a partial address to search for.' => '',
	// 'The geocode was successful but returned no results.' => '',
	// 'You are over your quota. If this is a shared server, enable <a href="{url}">Google Maps API Keys.</a>' => '',
	// 'Your request was denied for some reason.' => '',
	// 'Invalid request. Please provide more address information.' => '',
	...
	// 'All documentation can be found at <a href="{url}" target="_blank">Craft Plus</a>.' => '',
	// 'You can reach us at {supportEmail}. All questions, comments, and suggestions are welcome!' => '',
	// 'Google Maps API Keys' => '',
	// 'Using API keys is optional, but you may find it beneficial in many situations:' => '',
	// 'If your website is on a shared server, or' => '',
	// 'If you expect extremely high traffic to your website.' => '',
	...
	// '<strong>Step 3:</strong> Copy your <a href="{url}" target="_blank">security access information</a> and paste it here...' => '',
	// '(service disabled)' => '',
	// 'User ID' => '',
	// 'License Key' => '',
